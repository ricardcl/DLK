...
export class ParseurVEMGSA {
   ...
   */
  public parseLogVEMGSA(arcid: string, plnid: number, fichierSourceVemgsa: string[], creneau: creneauHoraire): void {
    console.log("Classe ParseurVEMGSA Fonction parseLogVEMGSA");
  ...
  public grepArcidFromPlnid(plnid: number, fichierSourceVemgsa: string, creneau: creneauHoraire): string {
    console.log("Classe parseurgVEMGSA Fonction grepArcidFromPlnid");
  ...
  private grepArcidFromReqid(reqid: number, fichierSourceVemgsa: string, creneau: creneauHoraire): string {
    console.log("Classe parseurpVemgsa Fonction grepArcidFromReqid");
  ...
  public grepPlnidFromArcid(arcid: string, fichierSourceVemgsa: string, creneau: creneauHoraire): number {
    console.log("Classe parseurpVemgsa Fonction grepPlnidFromArcid");
  ...
  public grepReqidFromArcid(arcid: string, fichierSourceVemgsa: string, creneau: creneauHoraire): number {
    console.log("Classe parseurpVemgsa Fonction grepReqidFromArcid");
  ...
  public parsePlagesHorairesFichiers(fichierSourceVemgsa: string[]): creneauHoraire {
    console.log("Classe parseurpVemgsa Fonction parsePlagesHorairesFichiers");
    ...
    for (let fichier of fichierSourceVemgsa) {
      creneauTemp = this.parsePlageHoraireFichier(fichier);
  ...
  private parsePlageHoraireFichier(fichierSourceVemgsa: string): creneauHoraire {
    console.log("Classe parseurpVemgsa Fonction parsePlageHoraireFichier");
  ...
  public orderVemgsa(list: string[]): string[] {
    console.log("Classe parseurpVemgsa Fonction orderVemgsa");

    let datesFichier1: creneauHoraire;
    let datesFichier2: creneauHoraire;
    datesFichier1 = this.parsePlageHoraireFichier(list[0]);
    datesFichier2 = this.parsePlageHoraireFichier(list[1]);
  ...
  public isPlnidAndPlageHoraire(plnid: number, fichierSourceVemgsa: string[]): arrayCreneauHoraire {
    console.log("Classe parseurpVemgsa Fonction isPlnidAndPlageHoraire");
  ...
  public isArcidAndPlageHoraire(arcid: string, fichierSourceVemgsa: string[]): arrayCreneauHoraire {
    console.log("Classe parseurpVemgsa Fonction isArcidAndPlageHoraire");
